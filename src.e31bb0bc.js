...
var data = {
  ...
  experienceBlock: {
    ...
    list: [{
      ...
      description: ["Lead Hyperlocal product. manage the sprint task and the team.", "Develop a design system from scratch for all the onlinesales products.", "Architect and refactor all the products from scratch in React JS."]
    }, {
      title: "Software Design Engineer, Agrostar",
      titleRight: "2/2019 - 2/2020",
      tags: ["React JS", "Redux", "Lerna.js"],
      description: ["Develop a design system from scratch for all the agrostar products.", "Own AgroEx product and manage the sprint task.", "Refactor 2 product AgroEx and Credit viswas from scratch in React JS."]
    }, {
      title: "Jr. Application Engineer, Odoo",
      titleRight: "7/2017 - 2/2019",
      tags: ["Javascript", "Python"],
      description: ["Develop ERP System based on ODOO's open source python and javascript based framework.", "Worked on enterprise product for new features and bug fixes. One of my work was also showcased on ODOO 11 launch video."]
    }, {
      title: "Intern, Odoo",
      titleRight: "1/2017 - 6/2017",
      tags: ["Javascript", "Python"],
      description: ["Develop ERP Feedback System on cloud based ODOO's open source python and javascript based framework."]
    }]
  },
  projectBlock: {
    blockTitle: "Projects",
    list: [{
      ...
      description: ["Devtool for debug ReactJS Context and useReducer API. Devtool have raw, tree and diff views of your JSON data. It allow you can dispatch actions from devtool in useReducer hook.", "10,000+ downloads in chrome web store"]
    }, {
      title: "Fire Dashboard",
      titleRight: "Chrome Extension",
      tags: ["React JS", "Chrome API"],
      description: ["New Tab Dashboard and Bookmark Manager. Fire dashboard is your all-in-one productivity tool with multiple workspace support.", "Bookmark management app that is better than bookmarks. Organize your browser tabs and access them quickly anywhere."]
    }, {
      title: "Webpack Report",
      titleRight: "Node Module",
      tags: ["React JS", "Emotion JS"],
      description: ["Webpack build analysis tool. it gives a detailed report for assets, modules and chunks so you can easily optimize your webpack build."]
    }]
  },
  skillBlock: {
    blockTitle: "Technical Skills",
    tags: ["Javascript", "ES6", "React JS", "Styled Component", "Redux", "Chrome Extension", "CSS", "SCSS", "Webpack"]
  }
};
var resume = "\n  <div class=\"resume-page-main-wrapper\">\n    <div class=\"resume-page-header\">\n\n    </div>\n    <div class=\"resume-wrapper\">\n      <div class=\"header\">\n        <div class=\"left-header\">\n          <div class=\"name\">".concat(data.name, "</div>\n          <div class=\"designation\">").concat(data.designation, "</div>\n        </div>\n        <div class=\"right-header\">\n          <table>\n            ").concat(data.contactDetails.map(function (contact) {
  return "\n                <tr>\n                  <td class=\"title\">".concat(contact.title, "</td>\n                  <td class=\"value\">").concat(contact.value, "</td>\n                </tr>\n              ");
}).join(""), "\n          </table>\n        </div>\n      </div>\n      <div class=\"link-nav\">\n        ").concat(data.socialDetails.map(function (social) {
  return "\n              <div class=\"link-block\">\n                <i class=\"".concat(social.icon, "\"></i>\n                <a\n                  href=\"").concat(social.link, "\"\n                  target=\"_blank\"\n                  class=\"value\"\n                >\n                  ").concat(social.title, "\n                </a>\n              </div>\n            ");
}).join(""), "\n      </div>\n      <div class=\"main-section\">\n        <div class=\"left\">\n          <div class=\"block\">\n            <div class=\"block-title\">Experience</div>\n            ").concat(data.experienceBlock.list.map(function (item) {
  return "\n                <div class=\"block-content\">\n                  <div class=\"content-title\">\n                    <div>".concat(item.title, "</div>\n                    <div class=\"right-title\">\n                      ").concat(item.titleRight, "\n                    </div>\n                  </div>\n                  <ul class=\"description-list\">\n                    ").concat(item.description.map(function (desc) {
    return "<li>".concat(desc, "</li>");
  }).join(""), "\n                  </ul>\n                </div>\n              ");
}).join(""), "\n          </div>\n        </div>\n        <div class=\"right\">\n          <div class=\"block\">\n            <div class=\"block-title\">").concat(data.profileBlock.title, "</div>\n            <div class=\"block-content\">\n              <div class=\"description-text\">").concat(data.profileBlock.description, "</div>\n            </div>\n          </div>\n          <div class=\"block\">\n            <div class=\"block-title\">").concat(data.educationBlock.blockTitle, "</div>\n            <div class=\"block-content\">\n              <div class=\"content-title\">").concat(data.educationBlock.title, "</div>\n              <div class=\"content-subtitle\">").concat(data.educationBlock.subTitle, "</div>\n              <div class=\"description-text\">").concat(data.educationBlock.description, "</div>\n            </div>\n          </div>\n          <div class=\"block\">\n            <div class=\"block-title\">").concat(data.skillBlock.blockTitle, "</div>\n            <div class=\"block-content wrap\">\n              ").concat(data.skillBlock.tags.map(function (tag) {
  return "<span class=\"tag\">".concat(tag, "</span>");
}).join(""), "\n            </div>\n          </div>\n        </div>\n      </div>\n      <div class=\"project-section\">\n        <div class=\"block\">\n          <div class=\"block-title border\">").concat(data.projectBlock.blockTitle, "</div>\n          ").concat(data.projectBlock.list.map(function (item) {
...
navigate(location.hash);
},{"./index.scss":"index.scss","./home":"home.js","./work":"work.js","./resume":"resume.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
